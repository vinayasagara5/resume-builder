        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/vinayasagara5/vinay-portfolio'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Linkdin'} href={'https://www.linkedin.com/in/vinaya-sagara-reddy-9b4425230/'}>
                        <FaLinkedin />
                    </SocialButton>
